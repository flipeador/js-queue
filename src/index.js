 ...
 */
export class QueueCanceled extends QueueError { }

/**
 * Exception thrown when {@link Queue.get()} is called on an empty queue.
 */
export class QueueEmpty extends QueueError { }

/**
 * Exception thrown when {@link Queue.put()} is called on a full queue.
 */
export class QueueFull extends QueueError { }
...
export class Queue
{
    ...
    get()
    {
        ...
        switch (this._type)
        {
            ...
            default: // !
                throw new QueueError(`Invalid queue type: ${this._type}`);
        }
    }
